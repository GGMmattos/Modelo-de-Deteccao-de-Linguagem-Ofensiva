...
<h2>Os esperimentos realizados foram divididos em rounds, desta forma temos</h2>

<p>R1: Onde são treinados e avaliados os modelos utilizando os algoritmos: Naive Bayes, Support Vector Machine(SVM), Multilayer Perceptron(MLP), Regressão Logística(LR)
...
R3_TOLD_BR_BERT: Modelo BERT aplicado em 100% do corpus TOLD_BR  e avaliado com a HateBR</p>
